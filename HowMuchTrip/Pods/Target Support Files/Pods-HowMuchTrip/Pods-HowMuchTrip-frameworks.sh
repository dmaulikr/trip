...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-HowMuchTrip/FBSDKCoreKit.framework"
  install_framework "Pods-HowMuchTrip/FBSDKLoginKit.framework"
  install_framework "Pods-HowMuchTrip/MBProgressHUD.framework"
